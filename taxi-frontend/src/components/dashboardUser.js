    ...
    return (
        <div id="nav-bar">
            ...
            <div id="nav-content">
                ...
                <div class="nav-button"><FontAwesomeIcon icon={faPlus } className="fas" /><span>New ride</span></div>
                <div class="nav-button"><FontAwesomeIcon icon={faListAlt } className='fas' /><span>Previous Rides</span></div>
            </div>

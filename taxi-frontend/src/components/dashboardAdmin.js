    ...
    return (
        <div id="nav-bar">
            ...
            <div id="nav-content">
                ...
                <div class="nav-button"><FontAwesomeIcon icon={faCheckCircle} className="fas" /><span>Verification</span></div>
                <div class="nav-button"><FontAwesomeIcon icon={faCar} className='fas' /><span>All rides</span></div>
            </div>

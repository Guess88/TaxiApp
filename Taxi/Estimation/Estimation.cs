...
namespace Estimation
{
    ...
    /// </summary>
    internal sealed class Estimation : StatelessService, IEstimation
    {
        public Estimation(StatelessServiceContext context)
            : base(context)
        { }

        public async Task<EstimationValues> CalculateEstimation(string startAddress, string endAddress)
        {
